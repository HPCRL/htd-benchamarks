...
for item in sizesVGG + sizesResnet + sizesYolo:
    ...
    with open("../../../test/dilated_conv2d_nchw/dilated_conv2d.mlir", "rt") as fin:
        with open(f"../../../test/dilated_conv2d_nchw/input_mlir/dilated_conv2d_nchw_N{N}_H{H}_W{W}_CO{CO}_CI{CI}_KH{KH}_KW{KW}_ST_{stride}_padding_{pad}.mlir", "wt") as fout:
            for line in fin:
